 ...
 * but list individual files that should be ignored or added in the process.  
 * Look in the ignore:{}  and  additions:{}  setting for those.
 *
 */
module.exports = {
...
//////
////// Left Off Here:
//////   implement an { additions:{ links: {} } }
//////   that will add to the default behavior
//////   
//////   need links: {  'data/opstool-mpdReports/templates_email' : 'data/templates_email' }
     ...
     additions:{
        ...
        // create a root/data/[moduleName]/templates_email/  -> [pluginDir]/data/templates_email
        links:{
 ...
 */
     ...
     additions:{
        ...
        // create a [sailsRoot]/data/[moduleName]/templates_email/  -> [pluginDir]/data/templates_email
        links:{
            'data/[moduleName]/templates_email': 'data/templates_email'  
        }
    },
